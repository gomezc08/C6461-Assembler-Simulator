...
public class C6461Assembler {
    ...
    private static void passTwo(String fileName) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            // Handle Data: store a value in memory.
                ...
                // Update(s).
                listingFile.add(String.format("%06o %s", currentAddress, dataValue));
            ...
            // Handle actual instructions: LDR, LDX, etc.
                ...
                if (machineCodeStr != null) {
                    ...
                    listingFile.add(output.toString());
                ...
                // Handle invalid instructions
                    ...
                    listingFile.add(String.format("%06o %s", currentAddress, "null"));
                    loadFile.add(String.format("%06o %s", currentAddress, "null"));
                }
            }

            else if(parts[1].equalsIgnoreCase("HLT")) {
                listingFile.add(String.format("%06o %s", currentAddress, "000000"));
    ...
    private static String getOperandValue(String opcode, String operand) {
        int register = 0, indexRegister = 0, address = 0;
        int indirectBit = 0;  // Default to direct addressing unless specified

        // Split the operand by commas
        String[] parts = operand.split(",");
        if (parts.length > 0) {
            if (opcode.equals("LDR") || opcode.equals("STR") || opcode.equals("LDA") || opcode.equals("JZ") || opcode.equals("JNE") || opcode.equals("SOB") || opcode.equals("JGE")) {
        ...
        // Get opcode binary from the map
        String opcodeBinary = opcodeMap.getOrDefault(opcode, "000000");
        
        // Convert register to binary (2 bits)
        ...
        // Convert address to binary (5 bits)
